  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        ...
        <a href="<?php echo base_url('petugas/tambahData')?>" class="btn btn-primary pull-left" style="width: 30%;">Tambah Data Petugas</a>
...
<script type="text/javascript">
  function deleted(param){
    ...
    if(proc){
      document.location='<?php echo base_url(); ?>petugas/deletedata/'+param;
    }
  }
  function updatejs(param){
      document.location='<?php echo base_url(); ?>petugas/editData/'+param;
  }
</script>
