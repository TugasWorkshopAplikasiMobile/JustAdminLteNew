            ...
            <div class="active tab-pane" id="activity">
              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal">
                  ...
                  <div class="form-group"><label for="inputAyahname" style="margin-left: 20px;">1. Data Ayah</label></div>
                  <div class="form-group">
                ...
                <div class="form-group"><label for="inputAyahname" style="margin-left: 20px;">2. Data Ibu</label></div>
                  <div class="form-group">
